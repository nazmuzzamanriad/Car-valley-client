...
3. It will redirect after confirm login
4. It has a nested route for admin panel
5. Dashboard is available for users and admin panel
6. users can view its order and also delte
7. Admin panel can delete all products
8. Admin panel can delete each products 
# Live site Link
